...
exports.getConnectionStr = exports.getWebSocketClass = exports.getNextRetryDelay = void 0;
...
exports.getNextRetryDelay = getNextRetryDelay;
...
function getConnectionStr(connectionMetadata, isPolling) {
    var gurl = urllib.parse(connectionMetadata.gurl);
    if (isPolling) {
        gurl.hostname = 'gp-v2.herokuapp.com';
        gurl.host = 'gp-v2.herokuapp.com';
        gurl.pathname = "/wsv2/" + connectionMetadata.token + "/" + encodeURIComponent(connectionMetadata.gurl);
    }
    else {
